...
import navIcon3 from '../assets/img/nav-icon3.svg'; // Other social icon
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/prabhu-prasad-panda-2394332b7/" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://example.com" target="_blank" rel="noopener noreferrer">
                  <img src={navIcon3} alt="Other Social" /> {/* Updated with a valid URL */}
                </a>
              </div>
              <HashLink to='#connect'>
